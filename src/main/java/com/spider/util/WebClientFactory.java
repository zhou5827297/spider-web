...
public class WebClientFactory {
    ...
    private static final int TIMEOUT = ProxyConstant.TIMEOUT_READ;
    private static final int JAVASCRIPTTIMEOUT = ProxyConstant.JS_EXECUTE_TIMEOUT_READ;

    /**
     * 构建一个浏览器对象
     */
    public static WebClient getWebClient(ProxyBean proxyBean) {
